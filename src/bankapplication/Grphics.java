...
public class Grphics extends javax.swing.JFrame {
    ...
    public void paint(Graphics g){
        ...
        for (int i = 0; i < graphBalance.length; i++) {
            ...
            int y1 = (int) ((findMax() - graphBalance[i]) * yScale + padding);
        ...
        for (int i = 0; i < numberYDivisions + 1; i++) {
            ...
            if (graphBalance.length > 0) {
                ...
                g2.setColor(Color.BLACK);
                String yLabel = ((int) ((findMax() + (findMax() - findMin()) * ((i * 1.0) / numberYDivisions)) * 100)) / 100.0 + "";
    ...
    private void init(){//alternative method to initComponents()
        this.setPreferredSize(new Dimension(800, 600));
        setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);
        this.pack();
        this.setLocationRelativeTo(null);
